            ...
            <md-card-content>
                ...
                <div class="md-layout">
                    <div class="md-layout-item md-small-size-100 md-small-show"  style="text-align: center">
                        <md-button class="md-raised" @click="register"><md-icon>person_add</md-icon> Create Account</md-button>
                    </div>
                    <div class="md-layout-item md-small-size-100" style="text-align: center">
                        <md-button class="md-flat" @click="login"><md-icon>person_outline</md-icon> Log In</md-button>
                    </div>
