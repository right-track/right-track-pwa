...
<div class="shareAPIPolyfill-header">
 ...
 <div class="shareAPIPolyfill-icons-container title">
  <button class="${!configs.copyURL ? 'hidden': ''} tool-icon copy" data-tool="copyURL">
   ${icon.copyURL}
   <span class="the-icon-title">${language.copyURL}</span>
  </button>
